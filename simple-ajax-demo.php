 ...
 * Description: A minimal plugin demonstrating AJAX requests with nonce verification and CPT storage
 * Version: 1.0.0
 * Author: Pulak It Dev
 * Author URI: https://pulakit.dev
 * License: GPL2
 * Text Domain: simple-ajax-demo
 */
...
class Simple_Ajax_Demo {
    ...
    function init() {
        ...
        add_action('wp_ajax_submit_newsletter', [$this, 'handle_ajax_submission']);
    ...
    function handle_ajax_submission() {
        ...
        // $submitted_nonce = $_POST['newsletter_nonce_field'];
